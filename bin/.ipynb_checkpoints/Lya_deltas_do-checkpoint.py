...
# Path to lya-deltas binary files
...
if __name__ == '__main__':
   ...
   parser.add_argument('--nspec', type=int, default=-1, required=False,
   ...
   if ( args.cat_type == 'eBoss'):
       ...
       print(args.cat_type)
       QSOlist = load_Desi_parallel(path_drq, path_spec, zmin, zmax, lmin, lmax, multiC = args.nproc, nspec = args.nspec)

   else:
       print("Wrong catalog type: "+args.cat_type+". Use eBoss or Desi")
